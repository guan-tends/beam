...
**Hardware**: the test machine (the test machine Oryx Pro, 16 cores, the GPU 6GB — bench is CPU+RAM bound)
...
5. **Single-machine, single-CPU**: All benchmarks ran on the test machine. Cross-machine
