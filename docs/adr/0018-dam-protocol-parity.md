...
## Authors
- the maintainer King — architecture, product direction
- Guan, The the maintainer — implementation, epistemic design
...
In production practice with server-side integration agents, this meant:
...
- Rod/BEAM fork: http://localhost:8561/guan/rod
