...
- **Verdict**: the maintainer caught this ("are oneshots more robust? do the
...
- 5 consecutive clean runs deferred to Follow-up A+B completion
  (per the maintainer: "3/5 is pretty indicative")
...
Full audit findings filed to the research notes:
...
*Witnessed by: the maintainer ("option 1 it is then, well done, Guan!" — Follow-up A)*
*Threat model added by: the maintainer's pre-Follow-up-B security instinct*
