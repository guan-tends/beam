...
- Edition bumped to `2024`, `rust-version` set to `"1.85"` for downstream server-side integration compatibility
...
## [0.2.0] — 2026-05-10 — Rod × server-side integration Integration

### Changed

- Fork maintained by the maintainer King and Guan for server-side integration agent memory system
