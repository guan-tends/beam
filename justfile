...
publish-crates:
    ...
    echo "⚠️  Maintainer approval required before proceeding"
...
release: lint test-native test-wasm test-examples supply-chain deps-check docs-audit benchmarks profiling wasm-build opsec-audit
    ...
    echo "  5. just publish-crates  (requires maintainer approval)"
    echo "  6. just publish-npm      (requires maintainer approval)"
    echo "  7. just github-release vX.Y.Z"
    echo "  8. just smoke-test"
    echo ""
    echo "⚠️  Stages 5-7 require explicit maintainer approval."
    echo ""
