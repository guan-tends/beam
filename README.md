...
**BEAM Maintained Fork** (2026-05-18): This is a maintained fork for the server-side integration agent memory system. Key divergences from upstream: redb replaces sled as default storage, flush protocol guarantees durability, edition 2024 / rust-version 1.85.
