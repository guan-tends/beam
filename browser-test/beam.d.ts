...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1252: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_258: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_258_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_258_3: (a: number, b: number, c: number) => void;
